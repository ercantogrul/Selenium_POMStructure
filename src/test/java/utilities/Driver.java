...
public class Driver {
    ...
    // private, driver i degistirmeye kim yetkili, sadece ayni class icinde degistirilebilsin diye private
    // static ise kimin kullanabilecegine karar verir (herkes)
    ...
    private Driver() { //constructor Driver
        // constructor dan kimse obje üretmesin diye private tanimlanmis
    }
    ...
    public static WebDriver getDriver() {
        if (driver == null) {
            ...
            // bu düzen ayn i anda bir tane driver üretilmesini sagliyor (singilten pattern)
